...
export default function Home() {
  ...
  return (
    <div className="container my-3">
      ...
      {allStudents.length!==0 && (<h4>Select student for pass generation: </h4>)}
      {allStudents.length===0 &&(<button className="btn btn-success" onClick={getAllStudents}>Click</button>)}
